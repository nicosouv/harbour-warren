...
ApplicationWindow {
    ...
    Rectangle {
        ...
        function play(target, oc, comm, loss) {
            ...
            clash = 0; resultLabel.visible = false; visible = true
            anim.restart()
        }

        MouseArea { anchors.fill: parent }

        // attackers (badgers, pale) advance from the left; defenders (dark) from the right
        Row {
            id: attackers
            ...
            Repeater {
                ...
                Rectangle {
                    width: Theme.paddingMedium; height: Theme.paddingLarge; radius: 1
                    color: "#2b2b30"
        ...
        Row {
            ...
            Repeater {
                model: 14
                Rectangle { width: Theme.paddingMedium; height: Theme.paddingLarge; radius: 1; color: "#7a3a3a" }
            }
        }
    ...
    Rectangle {
        ...
        Column {
            ...
            Label {
                anchors.horizontalCenter: parent.horizontalCenter
                text: "Warren"; font.pixelSize: Theme.fontSizeHuge; color: Theme.highlightColor
            }
            Label {
                width: parent.width; wrapMode: Text.Wrap; horizontalAlignment: Text.AlignHCenter
